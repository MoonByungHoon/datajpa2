package jpabasic.data_jpa_2.repository.query;
...
public class OrderQueryRepository{
  ...
  public List<OrderQueryDto> findAllByDto_optimization() {
    ...
    List<OrderItemQueryDto> orderItems = em.createQuery("select new jpabasic.data_jpa_2.repository.query." +
  ...
  private List<OrderItemQueryDto> findOrderItems(Long orderId) {
    return em.createQuery("select new jpabasic.data_jpa_2.repository.query." +
                    "OrderItemQueryDto(oi.order.id, i.name, oi.orderPrice, oi.count)" +
                    "from OrderItem oi " +
                    "join oi.item i " +
